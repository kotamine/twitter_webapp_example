...
def main():
	...
	[language_data.append([l[0],l[1],l[1]]) for l in lang]
	[top_language_data.append([t[0],t[1],t[1]]) for t in top_lang] 
...
def top_tweets():
	...
	return render_template("top_tweets.html", 
		tweets = tweets, datetime_toptweets=datetime_toptweets) 
...
def trends():
	...
	return render_template("trends.html", trend = trend,
		trend_tweet=trend_tweet, datetime_trends=datetime_trends) 
